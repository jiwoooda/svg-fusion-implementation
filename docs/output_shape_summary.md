...
- `caption`: `regional indicator symbol letter z regional indicator symbol letter w`  
  (이번 실행에서는 선택된 캐시 샘플의 캡션이 `None`으로 출력될 수 있음)
...
- `mu shape`: `[1, 3, 128]`
- `mu mean/std`: `0.005289564374834299 / 0.03722125664353371`
- `log_var shape`: `[1, 3, 128]`
- `log_var mean/std`: `-0.004095636773854494 / 0.028789345157027847`
...
- `pred_noise mean/std`: `0.001687705866061151 / 0.7862018942832947`
